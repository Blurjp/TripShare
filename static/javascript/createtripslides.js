...
$(document).ready(function() {    
 ...
 $('a[name=Go_back_to_Step1]').click(function(e) {  
	...
	$('.multihop-calendar').live('click', function () {
  ...
  $('a[name=create_trip_step_3]').click(function(e) {  
   ...
   //if close button is clicked  
	...
	$('a[class=add_user_link]').live("click",function () {
		...
		$('.people_search_result ul').append('<li class="create_trip_user_link"><a class="remove_user_link"><span class="user_image"><img class="picture medium" alt=' + userid + ' src=' + image_link + '></span><span class="user_name">' + username + '</span></a><div sid="' + userid + '" class="create_trip_member_button_remove" ></div></li>');
	    $('.friend_dropdown_list ul').empty();
		$('.add_member').val('');
	});
	
	$('li[class=create_trip_user_link]').live("mouseenter",function () {
		
		var remove =  $(this).children('.create_trip_member_button_remove');
		remove.show();
		});
		
	$('li[class=create_trip_user_link]').live("mouseleave",function () {
		var remove =  $(this).children('.create_trip_member_button_remove');
		remove.hide();
		});
			
	
	$('.create_trip_member_button_remove').live("click",function () {
